...
gainNode.connect(audioContext.destination); // Start oscillator
...
document.querySelector("#wave").addEventListener("change", function (e) {
...
for (var i = 0; i < whiteBufferSize; i++) {
...
var pinkNoise = function () {
  ...
  node.onaudioprocess = function (e) {
    ...
    for (var _i = 0; _i < pinkBufferSize; _i++) {
      ...
      output[_i] = b0 + b1 + b2 + b3 + b4 + b5 + b6 + white * 0.5362;
      output[_i] *= 0.11; // (roughly) compensate for gain
...
var brownNoise = function () {
  ...
  node.onaudioprocess = function (e) {
    ...
    for (var _i2 = 0; _i2 < brownBufferSize; _i2++) {
      var white = Math.random() * 2 - 1;
      output[_i2] = (lastOut + 0.02 * white) / 1.02;
      lastOut = output[_i2];
      output[_i2] *= 3.5; // (roughly) compensate for gain
    }
  };
